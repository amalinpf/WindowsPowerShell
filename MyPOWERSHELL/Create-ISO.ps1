<#
9/30/20 ajm, To create an iso file from files/folders
From: https://www.giyaa.com/2020/01/31/how-to-make-an-iso-file-using-powershell-no-third-party-tool-required/
#>

...
$url = 'https://postfallsidahoorg.sharepoint.com/sites/FinanceDepartment'
$listname = "Travel Requests" #Change to the SharePoint list name to be used
$newViewTitle = "Modern Calendar View" #Change if you require a different View name
$StartDate = "Leave_x0020_Date"
$EndDate = "Return_x0020_Date"

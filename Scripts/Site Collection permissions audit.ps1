...
[cmdletbinding()]
    ...
    Try {
        ...
        #Export Permissions to CSV File
        $Permissions | Export-CSV $ReportFile -append -NoTypeInformation
...
$ReportFile = ".\Output\PermissionsItemLevel_$Site.csv"

#endregion
 
#Call the function to generate permission report   #default
Generate-PnPSitePermissionRpt -SiteURL $SiteURL -ReportFile $ReportFile -Recursive

#Call the function to generate permission report   #Inherit
#Generate-PnPSitePermissionRpt -SiteURL $SiteURL -ReportFile $ReportFile -Recursive -IncludeInheritedPermissions

#Include Items
#Generate-PnPSitePermissionRpt -SiteURL $SiteURL -ReportFile $ReportFile -Recursive -IncludeInheritedPermissions -ScanItemLevel
   #>


#To process for all in tenant

#Connect to Admin Center
<#
$TenantAdminURL = "https://postfallsidahoorg-admin.SharePoint.com"
...
ForEach($Site in $SitesCollections)
{
	...
	#$ReportFile = ".\Output\Permissions\$($Site.URL.Replace('https://postfallsidahoorg.sharepoint.com','').Replace('/','_')).CSV"
    
	# Single Report
	$ReportFile = ".\Output\Permissions\All.CSV"

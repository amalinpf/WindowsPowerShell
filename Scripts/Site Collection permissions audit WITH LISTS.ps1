...
#Function to Get Permissions Applied on a particular Object, such as: Web, List or Folder	Detailed?
...
[cmdletbinding()]
    ...
    Try {
        ...
        Function Get-PnPListPermission([Microsoft.SharePoint.Client.Web]$Web)
        {
            ...
            "Site Pages", "Solution Gallery","Style Library","Suggested Content Browser Locations","Theme Gallery", "TaxonomyHiddenList","User Information List","Web Part Gallery","wfpub","wfsvc","Workflow History","Workflow Tasks", "Pages","CCSAdvancedApprovalLog","CCSWFHistory_Common_ErrorLogs","CrowCanyonAppsEmails","CrowCanyonMailTemplates")
...
#region ***Parameters***
$Site = "CityEmployeeEvents"
$Root = "https://postfallsidahoorg.sharepoint.com/sites/" 
$SiteURL = $Root+$Site

$ReportFile = ".\Output\Permissions With Lists_$Site.csv"
#endregion
  
#Call the function to generate permission report
#Include Unique Users

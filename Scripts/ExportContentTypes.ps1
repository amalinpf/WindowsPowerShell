<# https://www.sharepointdiary.com/2018/02/sharepoint-online-export-import-content-type-using-powershell.html
...
$ContentTypeName= "Document Set"
$ExportFile = ".\output\ContentType_$ContentTypeName.xml"
...
$ContentTypeName= "Document Set"
$ImportFile = ".\output\ContentType_$ContentTypeName.xml"

...
GetUserAccessReport "https://inet.postfallsidaho.org" "\\amalin-pc\c$\Users\amalin\Documents\sharepoint\Scripts\Output\SharePoint_Permission_Report_Finance.csv"
Write-Host "Complete"

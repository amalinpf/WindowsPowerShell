...
$ReportFile="\\amalin-pc\c$\Users\amalin\Documents\SharePoint\Scripts\Output\PermissionsPNP_Item_SharePoint-svr.csv"
#endregion
 
#Call the function to generate permission report
#Generate-PnPSitePermissionRpt -SiteURL https://inet.postfallsidaho.org -ReportFile $ReportFile -Recursive
Generate-PnPSitePermissionRpt -SiteURL https://inet.postfallsidaho.org -ReportFile $ReportFile -Recursive -ScanItemLevel -IncludeInheritedPermissions

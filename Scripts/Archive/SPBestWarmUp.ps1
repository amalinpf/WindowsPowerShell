...
"@
                    $xmlTemplate | Out-File $xmlCmdPath -Force
                }
...
Function WarmUp() {
    ...
    # Warm up Topology http://sharepoint-dev:37869/default.aspx	
    NavigateTo "http://localhost:37869/Topology/topology.svc"		# SharePoint-Dev Central Administration
#    NavigateTo "http://localhost:32570/Topology/topology.svc"		# SharePoint-Svr Central Administration

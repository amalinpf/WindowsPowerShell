...
#Function to Copy library to Another site https://www.sharepointdiary.com/2020/03/sharepoint-online-copy-document-library-to-another-site.html
...
<# Only create template and library
...
#Parameters
$SourceSiteURL = "https://postfallsidahoorg.sharepoint.com/sites/CityClerkDepartment"
$DestinationSiteURL = "https://postfallsidahoorg.sharepoint.com/sites/CityClerkDepartment"
$SourceLibraryName = "Shared%20Documents"
$DestinationLibraryName = "Clerk_Documents"

...
# $outputPath = "\\triumph\homes$\amalin\Documents\WindowsPowerShell\Output\Test_Wss_Content_MissingAssembly_SRV_$(Get-Date -Format hhmmss).txt"
$outputPath = "c:\temp\WindowsPowerShell\Output\Test_Wss_Content_MissingAssembly_SRV_$(Get-Date -Format hhmmss).txt"
$dbName = "WSS_Content"

...
$ReportFile="\\amalin-pc\c$\Users\amalin\Documents\SharePoint\Scripts\Output\SP Permissions_Web_List_Folder_2-16-21.csv"
#endregion
...
#Call the function to generate permission report
Generate-PnPSitePermissionRpt -SiteURL $SiteURL -ReportFile $ReportFile -Recursive -ScanFolders

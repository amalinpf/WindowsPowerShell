<#
Copy List Items between Site Collections using PowerShell https://www.sharepointdiary.com/2019/05/sharepoint-online-copy-list-items-between-sites-using-powershell.html
#>
...
$DestinationConn = Connect-PnPOnline -Url $DestinationSiteURL -ClientId $ID -ClientSecret $Secret -ReturnConnection
...
$WorkAround = Copy-SPOListItems -SourceList $SourceList -DestinationList $DestinationList

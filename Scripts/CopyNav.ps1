function Get-SPOHubSiteNavigation{
        ...
        process{
                ...
                $connection = Connect-PnPOnline -Url $identity -interactive
                $site = Get-PnPSite
...
<# 
If copying the ROOT, in the csv replace:    "/
with                                        "https://postfallsidahoorg.sharepoint.com/

 #>
 
$masterHubNavUrl = "https://postfallsidahoorg.sharepoint.com/sites/CommunityDevelopmentProjects"
...
<#
$sites = @("https://[tenant].sharepoint.com/sites/[site]","https://[tenant].sharepoint.com/sites/[site]")
...
<# Get nav
Get-SPOHubNavigation -Identity "https://postfallsidahoorg.sharepoint.com/sites/CommunityDevelopment" -Export:$true
 #>
 
<# Write it
Copy-SPOHubNavigation -Identity "https://postfallsidahoorg.sharepoint.com/sites/TestHub2" -importCsv ".\Output\HubNavigation.csv"
